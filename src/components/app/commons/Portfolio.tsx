...
export function Portfolio({ hoverText = "", data: promiseData, aspect }: Props) {
	const rowData = use(promiseData);
					...
					<>
						{(() => {
							...
							if (targetData !== undefined) {
								return <PortfolioPage setSelectId={setSelectId} data={targetData} />;
							}
